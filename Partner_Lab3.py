...
def country_csv(file_name):
    ...
    1. Take the CSV file (with headers) and reads the items as a dictionary using DictReader()
    2. Create a CSV file that splits country by region, generating a file per region."""
